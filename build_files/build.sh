...
# https://pagure.io/workstation-ostree-config/blob/f44/f/common.yaml
dnf5 -y install --setopt=install_weak_deps=True \
  git-core \
  git-core-doc \
  buildah \
...
# https://pagure.io/workstation-ostree-config/blob/f44/f/packages/common.yaml
dnf5 -y install --setopt=install_weak_deps=True \
  bc \
  hostname \
  mtr

# https://pagure.io/workstation-ostree-config/blob/f44/f/packages/sway-atomic.yaml
dnf5 -y install --setopt=install_weak_deps=True \
  wl-clipboard
